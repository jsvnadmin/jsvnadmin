...
insert into i18n (lang,id,lbl) values ('en','login.info.setadmin','Welcome to SVN ADMIN,please set the administrator accout an password.');
...
insert into i18n (lang,id,lbl) values ('en','zh_CN','Simple Chinese');
